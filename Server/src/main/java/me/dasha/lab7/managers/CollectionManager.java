...
public class CollectionManager {
    ...
    public static void loadCollectionFromBd(User user){
        try {
            creationDate = LocalDateTime.now();
            stack.addAll(DataBaseHandler.loadCollection(user));
    ...
    public static boolean checkStackSize(int index) throws NullPointerException{
